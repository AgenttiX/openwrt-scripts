...
# qrencode is required for generating WireGuard QR codes.
opkg install bind-host curl git git-http librespeed-go luci-app-attendedsysupgrade luci-app-ddns luci-app-snmpd luci-proto-wireguard mosh-server nano owut qrencode tmux
